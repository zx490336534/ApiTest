									...
									<div style="overflow: auto">
										<table>
											...
											<tr v-for="validator in record.meta_data.validators">
												<td v-if="validator.check_result === 'pass'" class="passed">{{validator.check}}</td>
												<td v-else-if="validator.check_result === 'fail'" class="failed">{{validator.check}}</td>
												<td v-else-if="validator.check_result === 'unchecked'" class="unchecked">{{validator.check}}</td>
