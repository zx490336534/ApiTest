		...
		<div class="ms-login">
			...
			<el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="ms-content">
				...
				<el-form-item prop="password_conform">
					<el-input type="password" placeholder="请输入确认密码" v-model="ruleForm.password_conform" @keyup.enter.native="submitForm('ruleForm')"
					 @focus="clearValidate('password_conform')">
						<el-button slot="prepend" icon="el-icon-lx-lock"></el-button>
					</el-input>
				</el-form-item>
